...
parser.add_argument('--tiny_size', type=str, default='16')
...
def main():
    ...
    if FEATURE == 'tiny_image':
        ...
        target_size = (int(args.tiny_size), int(args.tiny_size) )
        train_image_feats = get_tiny_images(train_image_paths, target_size=target_size)
        test_image_feats = get_tiny_images(test_image_paths, target_size=target_size)
